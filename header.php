...
<!-- Site Metas -->
<title>News-Magazine - Stylish Magazine Blog Template</title>
                ...
                <div class="masonry-blog clearfix">
                    <div class="first-slot">
                        <div class="masonry-box post-media">
                            ...
                            <video width="718" height="349" loop="true" controls muted autoplay="autoplay">
                                <source src="images/vid.mp4" type="video/mp4">
                                <source src="images/vid.mp4" type="video/ogg">
                                <!-- Your browser does not support the video tag. -->
                            </video>
                            <!-- <iframe width="674" height="379" src="https://www.youtube.com/embed/WB-y7_ymPJ4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                    ...
                    <div class="second-slot">
                        <div class="masonry-box post-media">
                            <img src="images/baner.jpg" height="349" alt="" class="img-fluid">
                            <!-- end shadow-desc -->
                            <!-- end shadow -->
                        </div><!-- end post-media -->
                    </div><!-- end second-side -->
                    ...
                    <div class="last-slot">
                        <div class="masonry-box post-media">
                            <img src="images/baner_1.jpg" alt="" class="img-fluid">
                            <!-- end shadow -->
                        </div><!-- end post-media -->
                    </div><!-- end second-side -->
                </div><!-- end masonry -->
